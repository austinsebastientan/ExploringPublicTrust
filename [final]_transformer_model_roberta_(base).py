# -*- coding: utf-8 -*-
"""[FINAL] Transformer Model- Roberta (base)

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dxkVdqGWvgqj6ADMHRyPFmrbuAb8qjmA
"""
...
model.save_weights('/content/roberta-base.h5')
...
texts = ["2 years and nothing has changed! hay grabe ka mayor palpak ka talaga!! "]
text_features = roberta_encode(texts,tokenizer)
predictions = model.predict(text_features)
predictions = np.argmax (predictions, axis = 1)
for text, predicted in zip(texts, predictions):
...
Roberta_Trust = '/content/roberta-base.h5'
model = build_model(3)
