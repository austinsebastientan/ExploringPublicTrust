# -*- coding: utf-8 -*-
"""[FINAL] Transformer Model- Roberta (tagalog-large)

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qey6tBwIwUPkEKXujc21HiGY4uxAxk12
"""
...
MAX_LEN = 280
MODEL_NAME = "jcblaise/roberta-tagalog-large"
...
with tpu_strategy.scope():
  model = build_model(3)
  history = model.fit(X_train_tk,y_train,epochs=50, batch_size=16, validation_data=(X_test_tk, y_test), validation_split=0.5, verbose=1, callbacks=[early_stopping])
...
model.save_weights('/content/roberta-fil-large.h5')
