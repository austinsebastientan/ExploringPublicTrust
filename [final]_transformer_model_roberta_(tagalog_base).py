# -*- coding: utf-8 -*-
"""[FINAL] Transformer Model- Roberta (tagalog-base)

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15YnmDt4A3Gtc752Zm8CrfqXJeQeJkWZS
"""
...
tokenizer = RobertaTokenizer.from_pretrained("jcblaise/roberta-tagalog-base") #Tokenizer
...
model.save_weights('/content/roberta-fil.h5')
...
texts = ["Vaccines works kaya dapat pataasin pa booster dose para mamaintain yan feb to march kasi tumaas vaccination tataas uli case pag nagwane yung mga 1st and 2nd dose lang nabakunahan kaya dapat pataasin booster ", "2 years and nothing has changed! hay grabe ka, palpak ka talaga!!"]
text_features = roberta_encode(texts,tokenizer)
predictions = model.predict(text_features)
predictions = np.argmax (predictions, axis = 1)
for text, predicted in zip(texts, predictions):
